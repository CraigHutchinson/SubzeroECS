...
namespace SubzeroECS
{
	...
	namespace Intersection
	{
		 ...
		 * 
		 * When either iterator reaches end, both iterators are set to their respective
		 * end positions for consistency.
		 * 
		 ...
		 * 
		 * When either iterator is at end, both iterators are set to their respective
		 * end positions for consistency.
		 * 
		 ...
		 * @param end1 End iterator for first collection
		 * @param end2 End iterator for second collection
		 * @return true if at intersection or both at end
		 */
		template<typename Iterator>
		 ...
		 * 
		 * When either iterator reaches end after incrementing, both iterators are set
		 * to their respective end positions for consistency.
		 * 
		 * @tparam Iterator Type of iterator
		 ...
		 * 
		 * When any iterator reaches end, all iterators are set to their respective
		 * end positions for consistency.
		 * 
		 ...
		 * 
		 * When any iterator is at end, all iterators are set to their respective
		 * end positions for consistency.
		 * 
		 * @tparam Is Index sequence for parameter pack expansion
		 * @tparam Iterators Tuple of iterator types
		 * @param iterators Tuple of iterators (modified in place)
		 * @param endIterators Tuple of end iterators (same type as iterators)
		 * @return true if at intersection or all at end
		 */
		template<std::size_t... Is, typename Iterators>
		bool beginN(std::index_sequence<Is...> indices, Iterators& iterators, const Iterators& endIterators)
		{
			...
			{
				iterators = endIterators; // Set all to end
				return true;
			}
		 ...
		 * 
		 * When any iterator reaches end after incrementing, all iterators are set
		 * to their respective end positions for consistency.
		 * 
		 * @tparam Is Index sequence for parameter pack expansion
		 * @tparam Iterators Tuple of iterator types
